...
__decorate([
    (0, graphql_1.Mutation)(() => Boolean, { description: 'Register a new user with a 10-digit mobile number' }),
...
__decorate([
    (0, graphql_1.Mutation)(() => auth_user_model_1.AuthUser, { description: 'Login and receive a JWT stored in an HttpOnly cookie' }),
    __param(0, (0, graphql_1.Args)('input')),
...
__decorate([
    (0, graphql_1.Mutation)(() => Boolean, { description: 'Logout and clear the auth cookie' }),
...
__decorate([
    (0, graphql_1.Query)(() => auth_user_model_1.AuthUser, { description: 'Get the currently logged-in user' }),
